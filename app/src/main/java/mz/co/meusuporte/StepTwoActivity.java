...
public class StepTwoActivity extends AppCompatActivity {
	...
	private SharedPreferences profissao;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		profissao = getSharedPreferences("profissao", Activity.MODE_PRIVATE);
	...
	private void initializeLogic() {
		...
		add = new HashMap<>();
		add.put("categoria", "Agentes M-pesa");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Agente E-mola");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Taxista");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Cozinhiero");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Vendedor de roupa");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Vendedor de moto");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Carpinteiro");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Pedreiro");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Serralheiro");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Pintor");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Mecânico");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Revendedor de produtos ");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Técnico de TV");
		listmap.add(add);
		add = new HashMap<>();
		add.put("categoria", "Outros");
		listmap.add(add);
		...
		final String textToSpell = "Oque você faz?"; // O texto que você quer soletrar
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			textview1.setText(listmap.get((int)_position).get("categoria").toString());
			linear1.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View _view) {
					categoria.edit().putString("categoria", listmap.get((int)_position).get("categoria").toString()).commit();
					i.setAction(Intent.ACTION_VIEW);
					i.setClass(getApplicationContext(), StepTreeActivity.class);
					startActivity(i);
				}
